...
coreseLatest_data = pd.read_csv('../out/corese.4.6.3_loading-metrics.csv')
coresePrevious_data = pd.read_csv('../out/corese.4.6.2_loading-metrics.csv')

# Concatenate the two datasets into a single DataFrame for easier comparison
combined_data = pd.concat([coresePrevious_data, coreseLatest_data], ignore_index=True)
...
output_path = os.path.join(output_dir, 'loading_time_memory_comparison_corese_versions.png')
